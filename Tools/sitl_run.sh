...
echo model: $model
echo devel_path: $devel_path

working_dir=$devel_path/tmp
rootfs=$working_dir/rootfs
sitl_bin=$devel_path/bin/px4
src_path=`realpath $devel_path/..`
...
then
	...
	then
		...
		source $devel_path/share/mavlink_sitl_gazebo/setup.sh
